      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative mx-auto w-4/5">
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white focus-visible:ring-0"
            onClick={prevSlide}
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white focus-visible:ring-0"
            onClick={nextSlide}
          >
